...
writeFileSync(`${dir}/moe.sable.next.Nightly.yml`, manifest);
writeFileSync(
  `${dir}/moe.sable.next.Nightly.metainfo.xml`,
  readFileSync(`${dir}/moe.sable.next.Nightly.metainfo.xml.in`, 'utf8')
