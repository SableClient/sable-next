 ...
 */
export type CoreEvent = { "type": "sync_status" } & SyncStatus | { "type": "session_ended", reason: string, } | { "type": "room_list_diff", subscription: SubscriptionId, diffs: Array<VectorDiff<RoomSummary>>, } | { "type": "timeline_diff", subscription: SubscriptionId, diffs: Array<VectorDiff<TimelineItemView>>, } | { "type": "timeline_pagination", subscription: SubscriptionId, loading: boolean, reached_start: boolean, } | { "type": "typing", room_id: string, user_ids: string[], } | { "type": "encryption_status", status: EncryptionStatusView, } | { "type": "verification", user_id: string, flow_id: string, state: VerificationView, } | { "type": "presence", user_id: string, presence: PresenceView, status_message: string | null, last_active_ago: number | null, };
